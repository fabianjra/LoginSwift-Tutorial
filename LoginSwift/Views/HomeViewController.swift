...
class HomeViewController: UIViewController {
    ...
    @IBAction func logoutButtonPressed(_ sender: Any) {
        ...
        //Como ya en la nueva pantalla se establecio que iba a ser RootViewController, entonces no se puede simplemete hacer un "back", porque ya no hay pantallas hacia atras. Este se convirtio en el base.
        //Se hace lo mismo que en la primera pantalla, para convertir la anterior, en la nueva base.
