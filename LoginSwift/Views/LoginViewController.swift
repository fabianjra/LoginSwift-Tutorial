...
class LoginViewController: UIViewController {
    ...
    @objc func loginButtonPressed(){
        ...
        //Llama al ViewCOntroller del Storyboard para luego hacerle un Push (comentado).
        if let vc = storyboard.instantiateViewController(withIdentifier: "HomeViewController") as? HomeViewController{
            //self.navigationController?.pushViewController(vc, animated: true)
            
            //Esta asignado el ViewController como RootViewControoler, asi que va a estar de primero en el navigationStack.
            //Convierte a la pantalla a la que se dirige, como la principal.
